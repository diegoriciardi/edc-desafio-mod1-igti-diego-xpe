...
spark = (
    SparkSession
    .builder
    .appName("DesafioMod1Spark")
    .getOrCreate()
)

rais = (
    spark.read
    .csv("s3://datalake-igti-diego-xpe-tf-producao-615564902404/RAIS-2020/", inferSchema=True, header=True, sep=';', encoding="latin1")
)
...
(
    ...
    .partitionBy('ano', 'uf')
    .format('parquet')
    .save('s3://datalake-igti-diego-xpe-tf-producao-615564902404/processing-zone/rais/')
)
