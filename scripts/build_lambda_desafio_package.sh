...
LAMBDA_FUNCTION=../../etl/lambda_function_desafio.py

# Verifica se o arquivo lambda_function_desafio.py existe
if [ -f $LAMBDA_FUNCTION ]
then
	echo "============================================="
	echo "Copiando função Handler..."
	cp $LAMBDA_FUNCTION .
	echo "Compactando arquivo lambda_function_desafio_payload.zip"
	zip -r9 ../lambda_function_desafio_payload.zip . #Compacta o pacote para o deploy
